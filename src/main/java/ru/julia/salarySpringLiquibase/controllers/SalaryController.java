 ...
 * 6) метод, в который передаю название csv файла. Метод перекладывает файл в таблицу в БД. Использовать OpenCsv
...
//    }
    ...
    public void deleteSalaryById(@RequestParam("id") Long id) {
